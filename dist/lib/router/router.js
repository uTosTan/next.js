...
function () {
  ...
  (0, _createClass2.default)(Router, [{
    ...
    value: function urlIsNew(asPath) {
      var _parse2 = (0, _url2.parse)(asPath, true),
          pathname = _parse2.pathname,
          query = _parse2.query;

      var _parse3 = (0, _url2.parse)(this.asPath, true),
          curPathname = _parse3.pathname;

      return curPathname !== pathname || !(0, _shallowEquals.default)(query, this.query);
    }
  }, {
        ...
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                _parse4 = (0, _url2.parse)(url), pathname = _parse4.pathname;
                route = toRoute(pathname);
